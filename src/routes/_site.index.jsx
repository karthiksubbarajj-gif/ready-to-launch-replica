...
const Route = createFileRoute("/_site/")({
  head: () => ({
    meta: [
    ...
    /* SERVICES */
      ...
      <section className="container-page py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {services.map((s) => <div key={s.title} className="group rounded-2xl bg-surface border border-border p-5 hover:border-orange/60 transition">
      ...
      <section className="container-page py-10">
        ...
        <div className="relative">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {projects.map((p) => <div key={p.title} className="rounded-2xl overflow-hidden bg-surface border border-border group">
      ...
      <section className="container-page py-14 grid lg:grid-cols-3 gap-5">
        ...
        <div className="rounded-2xl bg-surface border border-border p-6">
          ...
          <ul className="space-y-1.5 text-sm">
            {["Digital Marketing", "Social Media Management", "Freelancing", "Canva Designing", "Meta Ads"].map((i) => <li key={i} className="flex items-center gap-2"><GraduationCap className="h-4 w-4 text-purple" />{i}</li>)}
          </ul>
    ...
    /* STATS */
      ...
      <section className="container-page py-6">
        <div className="rounded-2xl border-2 border-orange/60 bg-surface/60 p-6 grid grid-cols-2 md:grid-cols-5 gap-6">
          {stats.map((s) => <div key={s.label} className="flex items-center gap-3">
    ...
    /* BLOG */
      ...
      <section className="container-page py-14">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {blogs.map((b) => <article key={b.title} className="rounded-2xl bg-surface border border-border overflow-hidden group">
